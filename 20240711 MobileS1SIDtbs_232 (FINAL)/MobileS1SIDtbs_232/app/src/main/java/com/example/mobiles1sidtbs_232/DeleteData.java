...
public class DeleteData extends AppCompatActivity {
    ...
    //deklarasi variabel
    private EditText code_txtNIM;
    private Button code_btnHapus;
    private TextView code_txtStatus;

    //deklarasi variabel tambahan
    private String URL = "http://172.16.60.99/mobile_dtbs/delete.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        code_btnHapus = (Button)findViewById(R.id.btnHapus);
        code_txtStatus = (TextView) findViewById(R.id.txtStatus);

        //ketikan btnHapus diklik
        code_btnHapus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                try {
                    ...
                    if (nim.equals("")) //jika inputan kosong
                    {
                    ...
                    else
                    {
                        ...
                        stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                ...
                                //cek apakah response = "Delete" atau "Gagal Delete"
                                //jika response = "Delete", akan muncul Toast Data Berhasil Dihapus
